...
export const AboutHeroSectionContent = {
    ...
    description: "At Dr. Shreyank Educare, we help students move beyond confusion and build true understanding through structured, personalized, and engaging learning experiences.",
...
export const ServicesHeroSectionContent = {
    ...
    description: "From personalized tutoring to structured exam preparation and summer programs, we provide the right support at every stage of your academic journey.",
    buttonText: "Get a free consultation",
    image: {
...
export const ResourcesHeroSectionContent = {
    ...
    description: "Explore helpful study materials, watch real tutoring sessions, and get answers to common questions , all designed to support students beyond the classroom.",
    buttonText: "Get a free consultation",
