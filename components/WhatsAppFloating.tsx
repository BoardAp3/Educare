...
const WhatsAppFloating = () => {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <span className="absolute right-full mr-3 px-3 py-1 bg-white text-slate text-sm font-montserrat font-medium rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap border border-gray-100">
        Chat with us
      </span>
