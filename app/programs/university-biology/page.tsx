...
export const metadata: Metadata = {
  title: "University Biology | Dr. Shreyank Educare",
  description:
    "Master advanced university-level biology with focused academic support at Dr. Shreyank Educare.",
};
...
export default function UniversityBiologyPage() {
