...
export const metadata: Metadata = {
  title: "French Course | Dr. Shreyank Educare",
  description:
    "Develop strong French communication skills with interactive lessons and cultural understanding at Dr. Shreyank Educare.",
};
